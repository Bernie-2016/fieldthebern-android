...
public class ApiAddress extends CanvassData implements Parcelable {
  ...
  public static ApiAddress from(@NonNull Address address, @Nullable String apartment) {
    ...
    return new ApiAddress().type(ApiAddress.TYPE)
        .attributes(new Attributes().street1(address.getAddressLine(0))
            .street2(apartment)
            .city(city)
  ...
  public static class Relationships implements Parcelable {
    ...
    public boolean equals(Object o) {
      ...
      if (mostSupportiveResident != null ? !mostSupportiveResident.equals(
          that.mostSupportiveResident) : that.mostSupportiveResident != null) {
        return false;
      }
      return !(lastVisitedBy != null ? !lastVisitedBy.equals(that.lastVisitedBy)
  ...
  public static class Attributes implements Parcelable {
    ...
    public boolean equals(Object o) {
      ...
      if (bestCanvassResponse != null ? !bestCanvassResponse.equals(that.bestCanvassResponse)
          : that.bestCanvassResponse != null) {
        return false;
      }
      return !(lastCanvassResponse != null ? !lastCanvassResponse.equals(that.lastCanvassResponse)
  ...
  public boolean equals(Object o) {
    ...
    if (relationships != null ? !relationships.equals(that.relationships)
        : that.relationships != null) {
      return false;
    }
