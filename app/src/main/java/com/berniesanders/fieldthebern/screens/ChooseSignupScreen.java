 ...
 */
@Layout(R.layout.screen_choose_signup) public class ChooseSignupScreen extends FlowPathBase {
  ...
  @FtbScreenScope static public class Presenter extends ViewPresenter<ChooseSignupView> {
    ...
    @Override public void dropView(ChooseSignupView view) {
      super.dropView(view);
      ButterKnife.unbind(this);
    }

    @OnClick(R.id.sign_up_email) void signUpEmail() {
      Flow.get(getView().getContext()).set(new SignupScreen(new UserAttributes()));
    }

    @OnClick(R.id.sign_up_facebook) void signUpFacebook() {
    ...
    @OnClick(R.id.have_an_account) void haveAccount() {
