  ...
  static public class Presenter extends ViewPresenter<NewVisitView> {
    ...
    public void score() {
      ...
      if (noOneHome) {
        ...
        ((ApiAddress) visitRepo.get().included().get(0)).attributes()
        ...
        ((ApiAddress) visitRepo.get().included().get(0)).attributes().bestCanvassResponse(null);
      }

      ((ApiAddress) visitRepo.get().included().get(0)).attributes().lastCanvassResponse(null);
      if (!formIsValid()) {
        return;
      }
