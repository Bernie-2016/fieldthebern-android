...
public class AddPersonView extends RelativeLayout {
  ...
  private void injectSelf(Context context) {
    ...
    DaggerService.<AddPersonScreen.Component>getDaggerComponent(context,
  ...
  protected void onFinishInflate() {
    ...
    ArrayAdapter<String> adapter =
        new ArrayAdapter(getContext(), R.layout.party_spinner_item, R.id.text,
    ...
    //noinspection unchecked
    ArrayAdapter<CharSequence> interestAdapter =
        new ArrayAdapter(getContext(), R.layout.party_spinner_item, R.id.text,
