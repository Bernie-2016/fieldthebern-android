package org.feelthebern.android.providers;
...
public class SearchProvider extends ContentProvider
{
    ...
    public static final String 		AUTHORITY 				= "org.feelthebern.android.providers.SearchProvider";
    ...
    public boolean onCreate()
    {
        ...
        matrixCursor = new SearchMatrixCursor( null, getContext()  );
    ...
    public Cursor query( Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder )
    {
        ...
        SearchMatrixCursor  returnCursor = new SearchMatrixCursor ( null, getContext() );
